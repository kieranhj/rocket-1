...
MenuDescriptor g_editMenu[] = {
    ...
    {_T("Move selection up"), EDITOR_MENU_MOVE_UP, EMGUI_KEY_PAGE_UP, EMGUI_KEY_COMMAND, EMGUI_KEY_CTRL},
    {_T("Move selection down"), EDITOR_MENU_MOVE_DOWN, EMGUI_KEY_PAGE_DOWN, EMGUI_KEY_COMMAND, EMGUI_KEY_CTRL},
    {_T(""), EDITOR_MENU_SEPARATOR, 0, 0, 0},
...
MenuDescriptor g_viewMenu[] = {
    ...
    {_T("Unfold group"), EDITOR_MENU_UNFOLD_GROUP, EMGUI_KEY_ARROW_RIGHT, EMGUI_KEY_ALT | EMGUI_KEY_CTRL,
     EMGUI_KEY_ALT | EMGUI_KEY_CTRL},
    {_T(""), EDITOR_MENU_SEPARATOR, 0, 0, 0},
    {_T("Toogle bookmark"), EDITOR_MENU_TOGGLE_BOOKMARK, 'b', EMGUI_KEY_ALT, EMGUI_KEY_ALT},
	...
	{_T(""), EDITOR_MENU_SEPARATOR, 0, 0, 0},
	{_T("Toogle hex or decimal"), EDITOR_MENU_TOGGLE_HEXDEC, 'h', 0, 0},
	{_T("Cycle word size display"), EDITOR_MENU_CYCLE_SIZE, 'j', 0, 0},
	{0},
};
