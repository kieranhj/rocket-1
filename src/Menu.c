...
MenuDescriptor g_editMenu[] = {
    ...
    {_T("Move selection up"), EDITOR_MENU_MOVE_UP, EMGUI_KEY_PAGE_UP, EMGUI_KEY_SHIFT, EMGUI_KEY_SHIFT},
    {_T("Move selection down"), EDITOR_MENU_MOVE_DOWN, EMGUI_KEY_PAGE_DOWN, EMGUI_KEY_SHIFT, EMGUI_KEY_SHIFT},
    {_T(""), EDITOR_MENU_SEPARATOR, 0, 0, 0},
#if 0 // These were never passed through from the root window anyway.
    ...
    {_T(""), EDITOR_MENU_SEPARATOR, 0, 0, 0},
    {_T("Bias +0.01"), EDITOR_MENU_BIAS_P_001, 'q', EMGUI_KEY_ALT, EMGUI_KEY_ALT},
    {_T("Bias +0.1"), EDITOR_MENU_BIAS_P_01, 'w', EMGUI_KEY_ALT, EMGUI_KEY_ALT},
    {_T("Bias +1.0"), EDITOR_MENU_BIAS_P_1, 'e', EMGUI_KEY_ALT, EMGUI_KEY_ALT},
    {_T("Bias +10.0"), EDITOR_MENU_BIAS_P_10, 'r', EMGUI_KEY_ALT, EMGUI_KEY_ALT},
    {_T("Bias +10.0"), EDITOR_MENU_BIAS_P_100, 't', EMGUI_KEY_ALT, EMGUI_KEY_ALT},
    {_T("Bias +100.0"), EDITOR_MENU_BIAS_P_1000, 'y', EMGUI_KEY_ALT, EMGUI_KEY_ALT},
    {_T("Bias -0.01"), EDITOR_MENU_BIAS_N_001, 'a', EMGUI_KEY_ALT, EMGUI_KEY_ALT},
    {_T("Bias -0.1"), EDITOR_MENU_BIAS_N_01, 's', EMGUI_KEY_ALT, EMGUI_KEY_ALT},
    {_T("Bias -1.0"), EDITOR_MENU_BIAS_N_1, 'd', EMGUI_KEY_ALT, EMGUI_KEY_ALT},
    {_T("Bias -10.0"), EDITOR_MENU_BIAS_N_10, 'f', EMGUI_KEY_ALT, EMGUI_KEY_ALT},
    {_T("Bias -10.0"), EDITOR_MENU_BIAS_N_100, 'g', EMGUI_KEY_ALT, EMGUI_KEY_ALT},
    {_T("Bias -100.0"), EDITOR_MENU_BIAS_N_1000, 'h', EMGUI_KEY_ALT, EMGUI_KEY_ALT},
    {_T(""), EDITOR_MENU_SEPARATOR, 0, 0, 0},
...
MenuDescriptor g_viewMenu[] = {
    ...
    {_T("Unfold group"), EDITOR_MENU_UNFOLD_GROUP, EMGUI_KEY_ARROW_RIGHT, EMGUI_KEY_ALT | EMGUI_KEY_CTRL,
     EMGUI_KEY_ALT | EMGUI_KEY_CTRL},
    {_T(""), EDITOR_MENU_SEPARATOR, 0, 0, 0},
    {_T("Toogle bookmark"), EDITOR_MENU_TOGGLE_BOOKMARK, 'b', EMGUI_KEY_SHIFT, EMGUI_KEY_SHIFT},
